...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        # Cache images into memory for faster training (WARNING: large femur may exceed system RAM)
        self.imgs = [None] * n
        if cache_images:
...
def extract_boxes(path='../coco128/'):  # from utils.femur import *; extract_boxes('../coco128')
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from utils.femur import *; autosplit('../coco128')
    Arguments
...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False):
    ...
    Usage: from utils.femur import *; dataset_stats('coco128.yaml', verbose=True)
    Arguments
